...
resource "aws_iam_role" "aws_uc_feature_emr_service" {
...
#   role       = aws_iam_role.aws_uc_feature_emr_service.name
...
resource "aws_iam_policy" "emr_capacity_reservations" {
  name        = "aws_uc_featureCapacityReservations"
...
resource "aws_iam_role_policy_attachment" "aws_uc_feature_emr_service_ebs_cmk" {
  role       = aws_iam_role.aws_uc_feature_emr_service.name
